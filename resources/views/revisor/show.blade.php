...
<div class="container text-center">
  <div class="row row-cols-2 ">
    ...
    <div class="col-12 col-md-6">
        ...
        <div >
            ...
            <p class="d-inline">Adulti: <span class="{{ $image->adult }}"></span></p>
            <p class="d-inline">Satira: <span class="{{ $image->spoof }}"></span></p>
            <p class="d-inline">Medicina: <span class="{{ $image->medical }}"></span></p>
            <p class="d-inline">Violenza: <span class="{{ $image->violence }}"></span></p>
            <p class="d-inline">Contenuto ammiccante: <span class="{{ $image->racy }}"></span></p>
   ...
   <div class="col-12 col-md-6 d-flex justify-content-center">
    <form class="mx-3" action="{{ route('revisor.changeStatus' , ['announcement' => $announcement, 'value' => true]) }}" method="POST">
      @csrf
      @method('PATCH')
  ...
  <form action="{{ route('revisor.changeStatus' , ['announcement' => $announcement, 'value' => 'false']) }}" method="POST">
    @csrf
    @method('PATCH')
